...
add_filter( 'user_contactmethods', 'ultra_seven_author_meta_contact' );
add_filter( 'user_contactmethods', 'ultra_seven_author_designation' );

function ultra_seven_author_meta_contact() {
...
function ultra_seven_author_designation($author_profile){
...
if(!function_exists('getPostViews')){
    function getPostViews( $postID ){
        $count_key = 'ultra_seven_post_views_count';
...
*---------------------------
*/
if( !function_exists('ultra_seven_social_share') ){
    function ultra_seven_social_share($share_text = NUll){
