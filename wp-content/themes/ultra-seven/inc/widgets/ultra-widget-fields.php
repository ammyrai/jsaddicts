...
function ultra_seven_widgets_show_widget_field( $instance = '', $widget_field = '', $athm_field_value = '' ) {
    ...
    switch ( $ultra_seven_widgets_field_type ) {
        ...
        case 'section_header':
        ?>
        	<span class="section-header"><?php echo esc_attr( $ultra_seven_widgets_title ); ?></span>
        <?php
        	break;
        ...
        ?>
            <div class="layout-image-wrapper">
                <span class="image-title"><?php echo esc_attr( $ultra_seven_widgets_title ); ?></span>
        ...
        case 'multicheckboxes':            
            ...
            ?>
                <label class="wtitle"><?php echo esc_attr( $ultra_seven_widgets_title ); ?>:</label>
            <?php
            }?>
